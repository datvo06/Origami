 ...
 * alhasan@cs.rpi.edu, salems@cs.rpi.edu Modifications: added IBM and FASTA
 * tokenizers -- Zaki, 5/8/06
 *
...
#define ISET_PROP                                                              \
  proplist<no_edges, proplist<uniq_label, PP>> // PP stands for Pattern Property

#define MSET_PROP proplist<no_edges, PP> // PP stands for Pattern Property

#define SEQ_PROP                                                               \
  proplist<directed,                                                           \
           proplist<acyclic, proplist<indegree_lte_one,                        \
                                      proplist<outdegree_lte_one, PP>>>>

#define TREE_PROP                                                              \
  proplist<directed, proplist<acyclic, proplist<indegree_lte_one, PP>>>

#define ORD_TREE_PROP                                                          \
  proplist<                                                                    \
      directed,                                                                \
      proplist<acyclic, proplist<indegree_lte_one, proplist<ordered, PP>>>>

#define UNORD_TREE_PROP                                                        \
  proplist<                                                                    \
      directed,                                                                \
      proplist<acyclic, proplist<indegree_lte_one, proplist<ordered, PP>>>>
...
#define V_Fkk_IND_MINE_PROP                                                    \
  proplist<Fk_Fk, proplist<vert_mine, proplist<induced, MP>>>

#define V_Fk1_MINE_PROP proplist<Fk_F1, proplist<vert_mine, MP>>

// Tokenizer properties #defines
#define DMTL_TKNZ_PROP                                                         \
  proplist<dmtl_format, TP> // TP stands for tokenizer property
#define FASTA_TKNZ_PROP                                                        \
  proplist<fasta_format, TP> // TP stands for tokenizer property
