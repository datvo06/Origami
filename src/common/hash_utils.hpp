...
public:
  ...
  constexpr void update(const void *const data,
...
template <std::size_t Bits> struct fnv1a;
...
template <std::size_t Bits> using fnv1a_t = typename fnv1a<Bits>::type;

constexpr std::size_t hash_bytes(const void *const data,
                                 const std::size_t size) noexcept {
